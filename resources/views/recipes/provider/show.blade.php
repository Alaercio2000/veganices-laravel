            ...
            <main class="col-12">
                <div class="row">
                    ...
                    <div class="col-2 col-md-1 card-body d-flex align-self-center">
                        <a href="{{route('recipes.edit',['recipe'=> $recipe->id ])}}"><i
                                class="material-icons align-self-center mr-4 border-right pr-4">edit</i></a>
                        <form action="{{route('recipes.destroy',['recipe'=> $recipe->id])}}" method="post"
                            ...
                            <label for="delete"><i
                                    class="material-icons align-self-center text-danger">delete</i></label>
                        </form>
                    </div>
                ...
                <div style="font-size:30px" class="font-weight-bolder text-warning pb-4">R$
                    {{str_replace('.',',',$recipe->price)}}</div>
            </main>
        </div>
    </div>
</div>
