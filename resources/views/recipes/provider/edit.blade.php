...
<div class="d-flex justify-content-center">
    <div class="col-5">
        ...
        <form action="{{route('recipes.update',['recipe'=> $recipe->id ])}}" method="post" class="p-3"
            ...
            <div class="form-group">
                <textarea class="form-control @error('preparation_method') is-invalid @enderror"
                    name="preparation_method" id="preparation_method">{{$recipe->preparation_method}}</textarea>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                <select class="form-control @error('category_recipes_id') is-invalid @enderror"
                    name="category_recipes_id" id="category_recipes_id">
                    <option value="" onselect>Categoria</option>
                    @foreach ($categoryRecipes as $category)
                    <option {{($recipe->category_recipes_id == $category->id)?'selected':''}} value="{{$category->id}}">
            ...
            <div class="form-group">
                <input type="text" class="form-control @error('price') is-invalid @enderror" name="price" id="price"
                    value="{{$recipe->price}}" placeholder="Preço">
                <div class="invalid-feedback">
                    {{$errors->first('price')}}
                </div>
            </div>
            ...
            <div class="form-group">
                <input type="number" class="form-control @error('stock') is-invalid @enderror" name="stock"
                    id="stock" value="{{$recipe->stock}}" placeholder="Em estoque">
                <div class="invalid-feedback">
                    {{$errors->first('stock')}}
                </div>
            </div>
            ...
            <div class="form-group">
                <input type="file" class="form-control @error('imageRecipe') is-invalid @enderror" name="imageRecipe"
                    id="imageRecipe">
                <div class="invalid-feedback">
