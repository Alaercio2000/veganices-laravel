...
<head>
    ...
    <script src="{{asset('assets/js/template/script.js')}}"></script>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-6 d-none d-md-flex">
                    <a class="nav-link text-info font-weight-bold py-4 px-sm-1 px-md-2 px-lg-3 px-xl-4 pl-full-5 pr-full-4"
                        href="#">Sobre</a>
                    <a class="nav-link text-info font-weight-bold py-4 px-sm-1 px-md-2 px-lg-3 px-xl-4 pl-full-5 pr-full-4"
                        href="#">Produtos</a>
                    <a class="nav-link text-info font-weight-bold py-4 px-sm-1 px-md-2 px-lg-3 px-xl-4 pl-full-5 pr-full-4"
