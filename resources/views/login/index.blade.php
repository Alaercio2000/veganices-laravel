...
<form method="post" class="p-3">
    ...
    <div class="form-group">
        <input type="password" class="form-control @error('email') is-invalid @enderror" name="password" id="password" placeholder="Senha">
    </div>
...
<div class="text-center">
    <a href="#" class="btn border px-5 mr-4 social"><img class="mb-1" width="17"
            src="{{asset('assets/img/login/logo-facebook.png')}}" alt="logo facebook"><span class="text-secondary">
            Facebook</span>
    </a>
    <a href="#" class="btn border px-5 social"><img class="mb-1" width="17"
